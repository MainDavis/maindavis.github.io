...
| Feature | Description |
|---------|-------------|
| Token Impersonation | Duplicacion y uso de tokens de procesos privilegiados |
| Native Enumeration | Enumeracion nativa sin dependencias externas |
| Auto-Escalation | Flujo directo para elevar contexto cuando es viable |
